...
This repository provides the implementation of **FRESCO**  
(**F**actorized **R**epresentation for **E**nhanced **S**uper-resolution using latent **C**omponent-adversarial **O**ptimization), an unsupervised framework for unregistered hyperspectral-multispectral image fusion.
...
FRESCO addresses this unregistered setting using a two-stage framework:
